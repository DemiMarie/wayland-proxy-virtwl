...
I use [gitlab:talex5/crosvm](https://gitlab.com/talex5/crosvm/-/tree/0-unstable-2025-05-06-tal),
which has some important fixes applied (see the Git log for details).
It can be run as a Nix flake like this:

    nix run 'git+https://gitlab.com/talex5/crosvm.git?ref=0-unstable-2025-05-06-tal&submodules=1'
